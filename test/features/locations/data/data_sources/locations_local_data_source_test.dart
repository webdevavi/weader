...
void main() {
  LocationsLocalDataSourceImpl dataSource;
  MockSharedPreferences mockSharedPreferences;

  setUp(() {
    mockSharedPreferences = MockSharedPreferences();
    dataSource = LocationsLocalDataSourceImpl(
  ...
  group(
    ...
    () {
      ...
      test(
        'should return true removing all recently searched locations list',
        () async {
          // arrange
          when(mockSharedPreferences.remove(any))
              .thenAnswer((_) async => Future.value(true));
          // act
          final result = await dataSource.clearAllRecentlySearchedLocation();
          // assert
          expect(result, true);
        },
      );
